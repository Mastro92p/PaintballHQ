          ...
          {filtered.length > 0 ? (
            <div className="space-y-2">
              {filtered.map((l) => {
                ...
                const activeCount     = l.tournaments?.filter((t) => t.status === "active").length ?? 0;
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center justify-center w-20 shrink-0 px-3 py-4 border-r border-gray-100 dark:border-gray-800 self-stretch">
                      {l.logoUrl ? (
                        ...
                        <div className="w-10 h-10 rounded-full bg-teal-100 dark:bg-teal-900/30 flex items-center justify-center">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" className="text-teal-600 dark:text-teal-400">
                    ...
                    <div className="flex-1 min-w-0 px-5 py-4">
                      ...
                      <div className="flex sm:hidden items-center gap-2 mt-2 flex-wrap">
                        <span className="text-xs text-gray-400 dark:text-gray-500">
                          <span className="font-semibold text-gray-700 dark:text-gray-300 tabular-nums">{tournamentCount}</span> tournaments
                        </span>
                    ...
                    <div className="hidden sm:flex items-center gap-8 px-6 py-4 border-l border-gray-100 dark:border-gray-800 shrink-0">
                      <div className="text-center">
                        <p className="text-xs uppercase tracking-wider text-gray-400 dark:text-gray-500 font-medium">Tournaments</p>
                        <p className="text-base font-bold text-gray-900 dark:text-gray-100 tabular-nums">{tournamentCount}</p>
                      </div>
                      <div className="text-center">
